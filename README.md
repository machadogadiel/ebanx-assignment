...
Rationale: I wanted something very very simple as it's expected in this challenge, so I asked Gemini what was the simplest framework to implement a MVC, and choose Slim for it's popularity, simplicity and maturity. (Other options were Flight, and FrameworkX)
